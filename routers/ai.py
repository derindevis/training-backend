...
if not os.getenv("GEMINI_API_KEY"):
    raise RuntimeError("Gemini API is not set in .env file")
...
SYSTEM_CONTENT="""You are a helpful programming assistant for college
...
def ask_ai(
    ...
    try:
        ...
        raise HTTPException(
            status_code=503,
            detail="AI service  is temporarly  unavailable .Try again  in a moment. "
